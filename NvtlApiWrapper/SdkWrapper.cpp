...
NvtlApiWrapper::SdkWrapper::SdkWrapper()
{
	m_session = 0;
	m_hDll = 0;
...
void NvtlApiWrapper::SdkWrapper::ClearFunctionPointers()
{
...
bool NvtlApiWrapper::SdkWrapper::IsLoaded()
{
	return (m_hDll != NULL);
}

unsigned short NvtlApiWrapper::SdkWrapper::CreateSession()
{
...
bool NvtlApiWrapper::SdkWrapper::HasValidSession()
{
    return ( m_session != 0 );
}

unsigned short NvtlApiWrapper::SdkWrapper::GetSdkVersion( char* buffer, unsigned short buffer_len )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::SetSdkMode(NvtlSdkModeType sdk_mode, const char* szAccessKey )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::ReleaseSession()
{
...
unsigned short NvtlApiWrapper::SdkWrapper::RefreshDeviceInfo()
{
...
unsigned short NvtlApiWrapper::SdkWrapper::AttachDevice( DeviceDetail^ pDeviceDetail )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::DetachDevice()
{
...
unsigned short NvtlApiWrapper::SdkWrapper::ConfigureLogging( const char* filename, SdkLogLevelType logLevel, SdkLogOutputType output )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::UnlockDevice( unsigned char lockType, char* lockCode )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::SetAutoLock( unsigned char nAutoOn, char* lockCode )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetLockStatus( long* lockStatus, unsigned char* isAutoLockOn )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::ChangeLockCode( char* szOldCode, char* szNewCode )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::NetworkPreference( PropertyAction bPropAction, unsigned char* pref )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::NovaSpeedEnabled( PropertyAction bSet, unsigned char *NSEnabled )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetTemperature( unsigned short* temp )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetLifetimeTimer( unsigned long* count )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetDisplaySpeed( unsigned char nTheoretical, double* speed )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetDataCounters( unsigned long* dataTx, unsigned long* dataRx )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::AutoInstallEnabled( PropertyAction bSet, unsigned char* bEnabled )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::InternalMassStorageEnabled( PropertyAction bSet, unsigned char* bEnabled )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::RestoreToFactoryDefaults( char* spcCode )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::RestoreToFactoryDefaultsBasic()
{
...
unsigned short NvtlApiWrapper::SdkWrapper::IsLPMSupported( unsigned char* supported )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetRefurbInfo( unsigned char* status, unsigned long* date, char* provider, unsigned short provider_len)
{
...
unsigned short NvtlApiWrapper::SdkWrapper::SetSystemPreferredHybridMode( PropertyAction bSet, unsigned short newPrefMode, unsigned short newHybridMode, unsigned short* oldPrefMode, unsigned short* oldHybridMode )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::BandPreference( PropertyAction bPropAction, unsigned char nam, BandPreferenceType* pref )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetDateTime(NvtlTimeStruct^ ts)
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetEriInfo(EriInfoStruct^ eriInfo)
{
...
unsigned short NvtlApiWrapper::SdkWrapper::RoamPreference( PropertyAction bPropAction, unsigned char nam, RoamPreferenceType* pref )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::IntlRoamPreference( PropertyAction bPropAction, unsigned char* pref )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::MicroSDControl( PropertyAction bPropAction, unsigned char* enabled )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::LedControl( PropertyAction bPropAction, unsigned char* enabled )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetAvailableDevices( DeviceDetail^ pDevList, unsigned long* dev_list_size )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::SetDeviceAccessKey( char *szAccessKey )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::RegisterEventCallback( NvtlEventCallback cb)
{
...
unsigned short NvtlApiWrapper::SdkWrapper::UnregisterEventCallback( NvtlEventCallback cb)
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetDeviceInfo( DeviceInfoStruct^ pDevInfo )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetNetworkInfo( NetworkInfoStruct^ pNetInfo )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::ReadContact( short index, ContactInfoStruct^ pContact)
{
...
unsigned short NvtlApiWrapper::SdkWrapper::ReadMultipleContacts( unsigned short start_index, unsigned short num_to_read, ContactInfoStruct^ pContact, unsigned short* pRead )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::WriteContact( ContactInfoStruct^ pContact)
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetContactSizeDetails( ContactSizeInfoStruct^ pContactDetails )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetPowerMode(unsigned short* mode, unsigned char* disableMask)
{
...
unsigned short NvtlApiWrapper::SdkWrapper::SetPowerMode(unsigned short val)
{
...
unsigned short NvtlApiWrapper::SdkWrapper::RadioState( PropertyAction bPropAction, unsigned short* val)
{
...
unsigned short NvtlApiWrapper::SdkWrapper::Reset()
{
...
unsigned short NvtlApiWrapper::SdkWrapper::ReadSmsMsg( unsigned short index, SmsMessageStruct^ msg )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::SendSmsMsg( SmsMessageStruct^ msg )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::DeleteSmsMsg( unsigned short index )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetSmsList( SmsStateType eSmsType, SmsMessageInfo^ info_array, unsigned short array_size, unsigned short* msg_count)
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetBatteryState( unsigned short* state , unsigned short* chargePct )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetManufacturer( char* buffer, unsigned short* buffer_len )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::SMSC( PropertyAction propAct, char* buffer, unsigned short* buffer_len )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetImsi( char* buffer, unsigned short* buffer_len )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetIccid( char* buffer, unsigned short* buffer_len )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetNetworkMCCMNC( char* buffer, unsigned short* buffer_len )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetNetworkOperator( char* buffer, unsigned short* buffer_len )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::SetNetworkOperator( unsigned short mode, unsigned short format, unsigned short accessTech, char* szOper)
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetNetworkOperatorList( char* buffer, unsigned short* buffer_len )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::SendATCommand( char* command, char* prompt, char* response, unsigned long response_len )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::Band( PropertyAction bPropAction, unsigned long* band )
{
    LOAD_FUNCTION_PTR( fpNvtlGsm_Band, Func_NvtlGsm_Band, "NvtlGsm_Band", m_hDll );
	
    return fpNvtlGsm_Band(m_session, bPropAction, band );
}
unsigned short NvtlApiWrapper::SdkWrapper::SendStoredSms( unsigned short index )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::SetSmsStorage( const char* name )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetContactStorage( unsigned short* numRecords, unsigned short* maxRecords, char* buffer, unsigned short* buffer_len )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::SetContactStorage( char* szStorageName )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::WriteSmsMsg( SmsMessageStruct^ msg, unsigned short* index)
{
...
unsigned short NvtlApiWrapper::SdkWrapper::IsMsgMemoryFull( unsigned char* full )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetEnsInfo( unsigned long* ensMode )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetMobileId( char* buffer, unsigned short* buffer_len )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::GetMeid( char* buffer, unsigned short* buffer_len )
{
...
/*
unsigned short NvtlApiWrapper::SdkWrapper::GetMIPError( unsigned long* error )
{
...
*/
unsigned short NvtlApiWrapper::SdkWrapper::GetEsnAsDecimal( char* decEsn, unsigned short* decEsn_len )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::IsManualNetworkSelected( unsigned char* bManual )
{
...
unsigned short NvtlApiWrapper::SdkWrapper::DomainAttach( PropertyAction bPropAction, unsigned short* val)
{
